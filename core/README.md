...
| ✅ | `src/layer_engine.cpp` — the CapsLock state machine, the grace window, and the P7 forwarded-release invariant |
| ✅ | Test harness and `ctest` wiring; 46 tests, clean under `-Werror -Wconversion` |
